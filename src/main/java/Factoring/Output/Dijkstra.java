...
public class Dijkstra {
    ...
    public static Graph calculateShortestPathFromSource(Graph graph, Node source) {
        ...
        while (unsettledNodes.size() != 0) {
            Node currentNode = getLowestDistanceNode(unsettledNodes, source);
    ...
    private static void calculateMinimumDistance(Node adjacentNode, Integer edgeWeight, Node currentNode) {
    ...
    private static Node getLowestDistanceNode(Set < Node > unsettledNodes, Node start) {
        Node lowestDistanceNode = start;
